...
1. Write code to achieve your win conditions
2. Run your tests using `pnpm harness jest ...`
...
1. Push to a branch, open a PR, and let CI run to verify your win condition.
